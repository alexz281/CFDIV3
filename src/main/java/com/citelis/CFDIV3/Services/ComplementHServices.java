...
public class ComplementHServices {
    ...
    public ByteArrayInputStream load(String company_group, String id, String cfditype, String paymentmethod, Timestamp datestart, Timestamp dateend){
        ...
        Page<ComplementHModel> complementHModels = iComplementHRepository.findAll(builder.getValue(),Pageable.unpaged());
        ByteArrayInputStream in = ComplementHExcelExporter.complementHToExcel(complementHModels);
        return in;
    }
}
