...
import com.citelis.CFDIV3.Utils.RecipExcelExporter;
...
public class RecipServices {
    ...
    public ByteArrayInputStream load(String company_group, String id, String cfditype, Timestamp datestart, Timestamp dateend){
        ...
        Page<RecipModel> recipModels = iRecipRepository.findAll(builder.getValue(),Pageable.unpaged());
        ByteArrayInputStream in = RecipExcelExporter.recipToExcel(recipModels);
        return in;
    }
}
