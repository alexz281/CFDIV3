...
@Entity
@Table(name = "citcfdiexpensesincome")
@Data
public class IssuedModel {
    ...
    @Column(name="transferred_taxes_total_amount")
    float transferred_taxes_total_amount;

    @Column(name="withheld_taxes_total_amount")
    float withheld_taxes_total_amount;
